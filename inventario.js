    ...
    groups: [
      {
        group: 'Secos',
        items: [
          { name: 'Açúcar Demerara', unit: 'pct' },
          { name: 'Adoçante Zero Cal', unit: 'un' },
          { name: 'Arroz Integral', unit: 'pct' },
          { name: 'Arroz Parbolizado', unit: 'kg' },
          { name: 'Azeite de Oliva Misto (Cozinha)', unit: 'gal' },
          { name: 'Azeite de Oliva Puro (Cliente)', unit: 'gal' },
          { name: 'Café', unit: 'pct' },
          { name: 'Conhaque', unit: 'lt' },
          { name: 'Creme de Leite 0 Lactose', unit: 'un' },
          { name: 'Extrato de Tomate', unit: 'pct' },
          { name: 'Farelo de Aveia', unit: 'un' },
          { name: 'Farinha de Mandioca', unit: 'un' },
          { name: 'Farinha de Trigo', unit: 'pct' },
          { name: 'Feijão Preto', unit: 'pct' },
          { name: 'Leite de Coco', unit: 'un' },
          { name: 'Macarrão Fusilli', unit: 'pct' },
          { name: 'Maionese Hellmans', unit: 'bag' },
          { name: 'Mel', unit: 'kg' },
          { name: 'Milho Verde Conserva', unit: 'un' },
          { name: 'Molho Inglês', unit: 'lt' },
          { name: 'Mostarda Amarela', unit: 'gal' },
          { name: 'Pepino Conserva (Picles)', unit: 'un' },
          { name: 'Pimenta Clientes', unit: 'un' },
          { name: 'Pimenta do Reino', unit: 'un' },
          { name: 'Sal', unit: 'pct' },
          { name: 'Shoyu Light', unit: 'gal' },
          { name: 'Tapioca Granulada', unit: 'pct' },
          { name: 'Tomate Seco', unit: 'balde' },
          { name: 'Tortilha de Wrap', unit: 'pct' },
          { name: 'Vinagre Balsâmico', unit: 'gal' },
      ...
      },
      {
        ...
        items: [
          { name: 'Amêndoas Laminadas', unit: 'pct' },
          { name: 'Chia', unit: 'pct' },
          { name: 'Edamame', unit: 'pct' },
          { name: 'Ervas Finas', unit: 'pct' },
          { name: 'Farinha de Linhaça', unit: 'pct' },
          { name: 'Lemon Pepper', unit: 'pct' },
          { name: 'Louro', unit: 'pct' },
          { name: 'Mix Gergelim', unit: 'pct' },
          { name: 'Nozes', unit: 'kg' },
          { name: 'Orégano', unit: 'pct' },
          { name: 'Páprica Defumada', unit: 'kg' },
          { name: 'Semente de Girassol', unit: 'kg' },
          { name: 'Semente de Linhaça', unit: 'pct' },
          { name: 'Quinoa', unit: 'kg' },
        ]
      },
      {
      ...
      },
      {
        group: 'Proteínas',
        items: [
          { name: 'Bacon Cubos', unit: 'pct' },
          { name: 'Bacon Manta Feijoada', unit: 'un' },
          { name: 'Calabresa', unit: 'pct' },
          { name: 'Cogumelos', unit: 'kg' },
          { name: 'Costelinha', unit: 'pct' },
          { name: 'Mignon Cubos', unit: 'kg' },
          { name: 'Mignon Tiras', unit: 'kg' },
          { name: 'Peito de Frango', unit: 'kg' },
          { name: 'Posta Branca', unit: 'kg' },
          { name: 'Presunto Parma', unit: 'pct' },
        ]
      },
      {
        group: 'Pães',
        items: [
          { name: 'Pão Integral Charlotte', unit: 'pct' },
        ]
      },
      {
        group: 'Snacks',
    ...
    groups: [
      {
        ...
        items: [
          { name: 'Abobrinha do Balcão de Saladas', unit: 'pct' },
          { name: 'Arroz Integral Cozido', unit: 'pct' },
          { name: 'Bacon ao Forno', unit: 'kg' },
          { name: 'Base Creme Abóbora (porções 0,350g)', unit: 'kg' },
          { name: 'Base Creme Mandioca (porções 0,350g)', unit: 'kg' },
          { name: 'Batata Chips - Frita', unit: 'kg' },
          { name: 'Batata Palha - Frita', unit: 'pct' },
          { name: 'Cebolinha Picada', unit: 'pct' },
          { name: 'Cogumelos Fatiados', unit: 'pct' },
          { name: 'Cogumelos Grelhados', unit: 'kg' },
          { name: 'Couve Branqueada Wrap', unit: 'un' },
          { name: 'Couve Flor Triturada/Porcionada', unit: 'pct' },
          { name: 'Couve Refogada Feijoada', unit: 'un' },
          { name: 'Coxinha Massa', unit: 'un' },
          { name: 'Croutons', unit: 'kg' },
          { name: 'Farofa Brasileirinho (porções 0,030g)', unit: 'pct' },
          { name: 'Farofa de Cebola Feijoada', unit: 'un' },
          { name: 'Feijão Temperado', unit: 'kg' },
          { name: 'Feijoadinha', unit: 'kg' },
          { name: 'Frango Desfiado', unit: 'pct' },
          { name: 'Frango Desfiado Porcionado 30g', unit: 'pct' },
          { name: 'Frango em Cubos (Puxado)', unit: 'kg' },
          { name: 'Frango Cru em Cubos', unit: 'kg' },
          { name: 'Geléia de Pimenta (porções 0,030g)', unit: 'pct' },
          { name: 'Guacamole', unit: 'kg' },
          { name: 'Lasanha Bolonhesa', unit: 'un' },
          { name: 'Lasanha Vegetariana', unit: 'un' },
          { name: 'Legumes Brasileirinho Fatiados', unit: 'pct' },
          { name: 'Legumes Brasileirinho Grelhados', unit: 'pct' },
          { name: 'Mignon em Cubos 120g', unit: 'pct' },
          { name: 'Mignon em Cubos 70g', unit: 'pct' },
          { name: 'Mix de Sementes e Amêndoas', unit: 'pct' },
          { name: 'Mix de Spaghetti', unit: 'un' },
          { name: 'Molho Balsâmico Mostarda e Mel', unit: 'kg' },
          { name: 'Molho Golf', unit: 'kg' },
          { name: 'Molho Mostarda e Mel', unit: 'kg' },
          { name: 'Molho Pesto', unit: 'kg' },
          { name: 'Molho Pomodoro', unit: 'pct' },
          { name: 'Molho Ranch', unit: 'kg' },
          { name: 'Molho Sakura', unit: 'gal' },
          { name: 'Palitinho de Tapioca (6un / 0,025g)', unit: 'porção' },
          { name: 'Patê Pronto Sanduíche Natural', unit: 'kg' },
          { name: 'Parmegiana Congelado Pré-Assado', unit: 'un' },
          { name: 'Parmegiana Pré-Assado', unit: 'un' },
          { name: 'Posta Desfiada Porcionada 0,030g', unit: 'pct' },
          { name: 'Queijo Parmesão Ralado (0,020g)', unit: 'pct' },
          { name: 'Salada Colorida Strogonoff Delivery', unit: 'pct' },
          { name: 'Strogonoff de Frango Pré-Pronto (0,170g)', unit: 'kg' },
          { name: 'Strogonoff de Mignon Pré-Pronto (0,170g)', unit: 'kg' },
    ...
    groups: [
      {
        ...
        items: [
          ...
          { name: 'Bobina de Impressora Térmica', unit: 'cx' },
          ...
          { name: 'Canudos de Papel', unit: 'pct' },
          { name: 'Cartão Fidelidade', unit: 'milh' },
          { name: 'Colher Descartável', unit: 'pct' },
          { name: 'Copo Papel Descartável', unit: 'pct' },
          { name: 'Durex', unit: 'un' },
          { name: 'Embalagem 3 Divisórias', unit: 'cx' },
          { name: 'Embalagem Retangular', unit: 'cx' },
          { name: 'Etiqueta Validade', unit: 'un' },
          { name: 'Folha Enrolar Wrap', unit: 'fardo' },
          { name: 'Grampo Grampeador', unit: 'cx' },
          { name: 'Guardanapos', unit: 'cx' },
          { name: 'Lacre de Delivery', unit: 'un' },
          { name: 'Limpa Alumínio', unit: 'gal' },
          { name: 'Limpa Forno', unit: 'un' },
          { name: 'Palito de Dente', unit: 'cx' },
          { name: 'Pano de Chão', unit: 'un' },
          { name: 'Papel Interfolhado (Dispenser)', unit: 'rolo' },
          { name: 'Perfex', unit: 'rolo' },
          { name: 'Pilha', unit: 'un' },
          { name: 'Pote de Caldo', unit: 'pct' },
          { name: 'Pote Molho Salada', unit: 'cx' },
